...
# Import models — all must be imported so tables are created
from models.form import Form
from models.question import Question
from models.user import User
from models.response import Response
from models.otp_verification import OTPVerification    # ← new
...
from routes.otp import router as otp_router            # ← new
